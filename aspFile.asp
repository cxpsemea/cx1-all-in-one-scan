<%@ Page Title="WebGoat.Net - Edit Product" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="WebSite.Admin.EditProduct" %>
